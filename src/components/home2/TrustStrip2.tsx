...
export default function TrustStrip2() {
  ...
  return (
    <section className="bg-[#081426] border-b border-white/5 py-6 overflow-hidden">
      <div className="marquee-container opacity-40 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-500">
