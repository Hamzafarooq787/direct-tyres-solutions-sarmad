    ...
    <section className="py-24 bg-white border-b border-[#f0edec]">
      <div className="max-w-4xl mx-auto px-4 md:px-16">
        <Reveal className="text-center mb-12">
          <h2 className="text-4xl font-black text-[#0b1e3d] tracking-tight mb-4">
        ...
        <Reveal className="space-y-2">
          {faqsV2.map((faq) => (
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-2 p-6 text-[#0b1e3d] font-bold text-lg">
                {faq.question}
                <span className="shrink-0 rounded-full bg-white p-1.5 text-[#0b1e3d] group-open:-rotate-180 transition-transform duration-300 shadow-sm">
