            ...
            return (
              <Reveal key={service.title} delayMs={i * 100}>
                <div className="group relative rounded-3xl overflow-hidden h-[450px] border border-[#f0edec] transition-transform duration-500 ease-out hover:-translate-y-2.5 hover:shadow-xl">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0b1e3d] via-[#0b1e3d]/50 to-transparent opacity-90 transition-opacity duration-300 group-hover:opacity-100" />
                  <div className="absolute bottom-0 left-0 w-full p-8 flex flex-col justify-end">
                    <div className="w-12 h-12 bg-[#0058f7] rounded-2xl flex items-center justify-center mb-4 shadow-lg transform translate-y-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                    ...
                    <a
                      href="#contact"
                      className="text-white font-bold flex items-center gap-1.5 hover:text-[#0058f7] transition-colors w-fit"
                    >
                      Request Service{" "}
